...
<%@ attribute name="page" type="com.axing.crm.orm.Page" required="true"%>
...
<div style="text-align:right; padding:6px 6px 0 0;">
	...
	<% if (page.hasPreviousPage()){%>
		...
		&nbsp;&nbsp;
		<a href='?page=${page.number-1}&sortType=${sortType}&${searchParams}&${condition}'>上一页</a>
		&nbsp;&nbsp;
	<%}%>
	 
	<% if (page.hasNextPage()){%>
		<a href='?page=${page.number + 1}&sortType=${sortType}&${searchParams}&${condition}'>下一页</a>
		&nbsp;&nbsp;
